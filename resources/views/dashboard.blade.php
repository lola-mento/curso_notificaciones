            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4">
                ...
                <form action="{{route('messages.store')}}" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <x-jet-input name="subject" value="{{old('subject')}}" type="text" class="w-full" placeholder="Ingrese el asunto"/>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control w-full" name="body" placeholder="Escriba su mensaje" rows="4">{{old('body')}}</textarea>
